...
2. Download and install [Anaconda](https://www.anaconda.com/what-is-anaconda/):
        ...
        curl https://repo.continuum.io/miniconda/Miniconda3-4.3.31-MacOSX-x86_64.sh  > miniconda.sh
...
You have the option of working on your assignments in our hosted JupyterHub environment. If you are working on a Chromebook, this is what you will use throughout the course entirely. The Data 100 JupyterHub can be accessed at [data100.datahub.berkeley.edu](data100.datahub.berkeley.edu).
